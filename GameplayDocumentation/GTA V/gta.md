...
4. Travel to a populated area with multiple NPCs.

5. Attack civilians in order to trigger:
   - **Money Black**
   - **Money Green**
![Money Meter](images/money-meter.png)

6. Continue attacking civilians until the police become alerted.

7. Trigger the following wanted level meters:
   - **First Star**
   - **First Star Black 1**
   - **First Star Black 2**
![Wanted Meter](images/wanted-meter.png)

8. While wanted, continue attacking civilians to trigger:
   - **Money Green 2**
   - **Money Black 2**
![Money2 Meter](images/money2-meter.png)

9. Allow the police to shoot the player repeatedly.

10. Attack the police while continuing to take damage.

    This triggers:
   - **Low HP**
![Low Health Meter](images/lowhealth-meter.png)

11. Allow the police to kill the player.
...
12. After respawning from the hospital or police station, the following meters will trigger:
   - **Money Red**
